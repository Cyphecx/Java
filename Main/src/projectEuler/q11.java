...
public class q11 {
	static int[][] grid = new int[][]{
		...
		new int[]{67, 26, 20, 68, 02, 62, 12, 20, 95, 63, 94, 39, 63, 8, 40, 91, 66, 49, 94, 21},
		new int[]{24, 55, 58, 05, 66, 73, 99, 26, 97, 17, 78, 78, 96, 83, 14, 88, 34, 89, 63, 72},
		new int[]{21, 36, 23, 9, 75, 00, 76, 44, 20, 45, 35, 14, 00, 61, 33, 97, 34, 31, 33, 95},
		new int[]{78, 17, 53, 28, 22, 75, 31, 67, 15, 94, 03, 80, 04, 62, 16, 14, 9, 53, 56, 92},
		...
		new int[]{04, 52, 8, 83, 97, 35, 99, 16, 07, 97, 57, 32, 16, 26, 26, 79, 33, 27, 98, 66},
	...
	public static void main(String[] args) {
		...
		for(int i = 0; i < grid.length; i++){
			for(int x = 0; x < grid[i].length-3; x++){
				int temp = grid[i][x] * grid[i][x+1] * grid[i][x+2] * grid[i][x+3];
				if(temp > ans){
					ans = temp;
				}
			}
		...
		for(int i = 0; i < grid.length-3; i++){
			for(int x = 0; x < grid[i].length; x++){
				int temp = grid[i][x] * grid[i+1][x] * grid[i+2][x] * grid[i+3][x];
				if(temp > ans){
					ans = temp;
				}
			}
		...
		for(int i = 0; i < grid.length-3; i++){
			for(int x = 0; x < grid[i].length-3; x++){
				int temp = grid[i][x] * grid[i+1][x+1] * grid[i+2][x+2] * grid[i+3][x+3];
				if(temp > ans){
					ans = temp;
				}
			}
